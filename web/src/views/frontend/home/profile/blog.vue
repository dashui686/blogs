        ...
        <div class="container">
            ...
            <el-row>
                <template v-if="loading">
                    <el-col :md="8" class="blog-item" v-for="item in blogs as any" :key="item.id">
                        <div>
                ...
                <template v-else>
                    <el-col :md="8" class="blog-item" v-for="item in defaultBlogs as any" :key="item.id">
...
const loading = computed(() => {
    ...
    if (blogs!.value != null && blogs!.value !== undefined && blogs!.value!.length > 0) {
        return true
    }
